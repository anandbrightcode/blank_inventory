...
<table class="table-striped table-bordered table-hover table-condensed" id="c_list" style="width:100%" >
    ...
    <tr>
    	...
    	<td align="center">
			<a href="../invoice/print_service.php?inv_id=<?php echo $invoice['id'].""; ?>" class="btn btn-danger btn-xs fa fa-print"></a>
			<a href="../action/delete.php?deleteinvoiceservice=deleteinvoiceservice&id=<?php echo $invoice['id']; ?>" 
               class="btn btn-primary btn-xs fa fa-trash" onClick="return validate();"></a>
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li><a href="invoiceservice.php?pagename=report&page=<?php echo $page-1; 
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li <?php if($i==$page){echo "class='active'";} ?>>
                	<a href="invoiceservice.php?pagename=report&page=<?php echo $i; 
						if(isset($_GET['query'])){echo "&query=".$_GET['query'];}
						if(isset($_GET['from'])){echo "&from=".$_GET['from'];}
						if(isset($_GET['to'])){echo "&to=".$_GET['to'];}
					?>"><?php echo $i; ?></a>
