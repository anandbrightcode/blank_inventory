    ...
    <?php include "../header.php";?>
   		<div class="container">
     		<div class="row">
                ...
                <div class="col-md-10">
                	<center><font size="+2">Purchase Report</font></center><hr />
                    <div class="row">
                    	<div class="col-md-3">
                        	<select id="query" class="form-control" onchange="getTailorData(this.value)" >
                            	<option value="">Select</option>
                            	<option value="tailored" <?php if(isset($_GET['query']) && $_GET['query']=='tailored'){echo "selected";} ?>>Tailored</option>
                            	<option value="not_tailored" <?php if(isset($_GET['query']) && $_GET['query']=='not_tailored'){echo "selected";} ?>>Not Tailored</option>
                            </select>
                        </div>
                        <div class="col-md-1"></div>
                    	<div class="col-md-3">
                        	<input type="date" id="from" class="form-control" value="<?php if(isset($_GET['from'])){echo $_GET['from'];} ?>"/>
                        </div>
        ...
        <script language="javascript">
			...
			function getTailorData(str){
				...
				xhttp.open("GET", "tailor_list.php?query="+query+"&shop="+shop, true);
	 			xhttp.send();	
			}
			...
			function getDates(){
				...
				if(from=='' || to==''){
					...
					xhttp.open("GET", "tailor_list.php?from="+from+"&to="+to+"&shop="+shop, true);
					xhttp.send();	
				}
			}
			...
			function viewPurchase(str){
				...
				xhttp.open("GET", "productlist.php?id="+id+"&shop="+shop, true);
				xhttp.send();	
			}
