    ...
    <?php include "../header.php";?>
   		<div class="container">
     		<div class="row">
                ...
                <div class="col-md-10">
                	<center><font size="+2">Defective Product Report</font></center><hr />
                    <div class="row">
                    	<div class="col-md-4">
                        	<input type="text" id="query" placeholder="Enter Invoice No or Model to Search" class="form-control" onkeyup="getInvoiceData(this.value)"
        ...
        <script language="javascript">
			...
			function getInvoiceData(str){
				...
				xhttp.open("GET", "defectivelist.php?query="+query+"&shop="+shop, true);
	 			xhttp.send();	
			}
			...
			function getDates(){
				...
				if(from=='' || to==''){
					...
					xhttp.open("GET", "defectivelist.php?from="+from+"&to="+to+"&shop="+shop, true);
					xhttp.send();	
				}
			}
