    ...
    <?php include "../header.php";?>
   		<div class="container">
     		<div class="row">
                ...
                <div class="col-md-10">
                	<center><font size="+2">Quotation Report</font></center><hr />
                    <div class="row">
                    	<div class="col-md-3">
                        	<input type="text" id="query" placeholder="Enter Quotation No to Search" class="form-control" onkeyup="getQuotationData(this.value)"
        ...
        <script language="javascript">
			...
			function getQuotationData(str){
				var query=str;
				var shop='<?php echo $shop; ?>';
				//alert(query);
				$.ajax({
						type:"GET",
						url:"quotationlist.php",
