...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Perform Invoice Report</title>
    ...
    <?php include "../header.php";?>
   		<div class="container">
     		<div class="row">
                ...
                <div class="col-md-10">
                	<center><font size="+2">Perform Invoice Report</font></center><hr />
                    <div class="row">
                    	<div class="col-md-3">
                        	<input type="text" id="query" placeholder="Enter Perform Invoice No to Search" class="form-control" onkeyup="getInvoiceData(this.value)"
