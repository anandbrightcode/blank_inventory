    ...
    <?php include "../header.php";?>
   		<div class="container">
     		<div class="row">
                ...
                <div class="col-md-10">
                	<center><font size="+2">Dues Report</font></center><hr />
                    <div class="row">
                    	<div class="col-md-3">
        ...
        <script language="javascript">
			...
			function getInvoiceData(str){
				...
				xhttp.open("GET", "dueslist.php?query="+query+"&shop="+shop, true);
	 			xhttp.send();	
			}
			...
			function getDates(){
				...
				if(from=='' || to==''){
					...
					xhttp.open("GET", "dueslist.php?from="+from+"&to="+to+"&shop="+shop, true);
					xhttp.send();	
				}
			}
