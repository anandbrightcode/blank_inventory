...
<table class="table-striped table-bordered table-hover table-condensed" id="c_list" style="width:100%" >
    ...
    <tr>
    	...
    	<td align="center">
			<a href="../invoice/print_invoice.php?inv_id=<?php echo $invoice['id']."&page=report"; ?>" class="btn btn-danger btn-xs fa fa-print"></a>
			<a href="../action/delete.php?deleteinvoice=deleteinvoice&id=<?php echo $invoice['id']; ?>" 
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li><a href="../reports?pagename=report&page=<?php echo $page-1; 
	...
	?>	
    		<ul class="pagination pagination-sm">
    			<li <?php if($i==$page){echo "class='active'";} ?>>
                	<a href="../reports?pagename=report&page=<?php echo $i; 
						if(isset($_GET['query'])){echo "&query=".$_GET['query'];}
						if(isset($_GET['from'])){echo "&from=".$_GET['from'];}
						if(isset($_GET['to'])){echo "&to=".$_GET['to'];}
					?>"><?php echo $i; ?></a>
