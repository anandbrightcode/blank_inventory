...
--
-- Table structure for table `cust_pay_details`
--

CREATE TABLE `cust_pay_details` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `customer_id` int(11) NOT NULL,
  `payment_mode` varchar(21) NOT NULL,
  `cheque_no` varchar(21) NOT NULL,
...
CREATE TABLE `invoice` (
  ...
  `gst` varchar(30) NOT NULL,
  `reverse` varchar(3) NOT NULL,
  `add_from` varchar(200) NOT NULL,
  `add_to` varchar(200) NOT NULL,
  `consignee_name` varchar(100) NOT NULL,
  `consignee_mobile` varchar(12) NOT NULL,
  `consignee_address` text NOT NULL,
  `consignee_gst` varchar(30) NOT NULL,
  `consignee_state` varchar(30) NOT NULL,
  `consignee_code` varchar(2) NOT NULL,
...
--
-- Table structure for table `performa_list`
--

CREATE TABLE `performa_list` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `performa_temp`
--

CREATE TABLE `performa_temp` (
  `id` int(11) NOT NULL,
  `category` varchar(20) NOT NULL,
  `company_id` int(11) NOT NULL,
  `model` varchar(100) NOT NULL,
...
CREATE TABLE `purchase_order` (
  ...
  `discount` float NOT NULL,
  `custdiscount` float NOT NULL,
  `special_discount` float(4,2) NOT NULL,
  `cash_discount` float(4,2) NOT NULL,
  `taxable` float NOT NULL,
  `cgst` float NOT NULL,
  `sgst` float NOT NULL,
  `igst` float NOT NULL,
...
--
-- Table structure for table `quotservice_temp`
--

CREATE TABLE `quotservice_temp` (
  `id` int(11) NOT NULL,
  `description` text NOT NULL,
  `shsn` varchar(200) NOT NULL,
  `suom` varchar(100) NOT NULL,
  `squantity` varchar(200) NOT NULL,
  `srate` varchar(200) NOT NULL,
  `ser_gst` varchar(200) NOT NULL,
  `ser_gstvalue` varchar(200) NOT NULL,
  `samount` varchar(200) NOT NULL,
  `stotal_amount` varchar(200) NOT NULL,
  `shop` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `quot_list`
--

CREATE TABLE `quot_list` (
  `id` int(11) NOT NULL,
  `category` varchar(30) NOT NULL,
  `company_id` int(11) NOT NULL,
  `model` varchar(100) NOT NULL,
...
--
-- Table structure for table `quot_temp`
--

CREATE TABLE `quot_temp` (
  `id` int(11) NOT NULL,
  `category` varchar(20) NOT NULL,
  `company_id` int(11) NOT NULL,
  `model` varchar(100) NOT NULL,
...
--
-- Table structure for table `qutoservice`
--

CREATE TABLE `qutoservice` (
  `id` int(11) NOT NULL,
  `prefix` varchar(10) NOT NULL,
  `invoice_no` int(11) NOT NULL,
  `billing_mode` varchar(20) NOT NULL,
  ...
  `consignee_mobile` varchar(200) NOT NULL,
  `consignee_address` varchar(200) NOT NULL,
  `consignee_gst` varchar(200) NOT NULL,
  `consignee_state` varchar(200) NOT NULL,
  `consignee_code` varchar(200) NOT NULL,
  `gst` varchar(30) NOT NULL,
  `reverse` varchar(3) NOT NULL,
  `add_from` varchar(200) NOT NULL,
  `add_to` varchar(200) NOT NULL,
  ...
  `state` varchar(30) NOT NULL,
  `code` varchar(2) NOT NULL,
  `sgross_amount` float NOT NULL,
  `transport` float NOT NULL,
  `sroundoff` float NOT NULL,
  `stotal_amount` float NOT NULL,
  `paid` float NOT NULL,
  `dues` float NOT NULL,
  `next_payment` date NOT NULL,
  `add_terms` text NOT NULL,
...
--
-- Table structure for table `qutoservicelist`
--

CREATE TABLE `qutoservicelist` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `service_temp`
--
...
INSERT INTO `shop` (`id`, `name`, `address`, `address2`, `district`, `pin`, `state`, `phone`, `email`, `gst`, `abv`, `bank`, `account`, `ifsc`) VALUES
(1, 'APURVA HOMOEO HALL', 'Opp. Road No.-5 Near IGNOU, Ashok Nagar', '', 'Ranchi', '834002', '20', '7004787912', '', '', 'AHH', '', '', '');
...
--
-- Table structure for table `sup_pay_details`
--

CREATE TABLE `sup_pay_details` (
  `id` int(11) NOT NULL,
  `date` date NOT NULL,
  `supplier_id` int(11) NOT NULL,
  `payment_mode` varchar(21) NOT NULL,
...
INSERT INTO `users` (`id`, `username`, `password`, `role`, `shop`, `created_on`, `active`) VALUES
(1, 'admin', '12345', 'admin', 1, '2017-12-04 21:15:20', 1),
(2, 'user', '12345', 'user', 1, '2017-07-26 10:21:55', 1);
...
ALTER TABLE `customer_pay`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_custinvid` (`invoice_id`);

--
-- Indexes for table `cust_pay_details`
--
ALTER TABLE `cust_pay_details`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `performa_list`
--
ALTER TABLE `performa_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_pinvid` (`invoice_id`);

--
-- Indexes for table `performa_temp`
--
ALTER TABLE `performa_temp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `quotservice_temp`
--
ALTER TABLE `quotservice_temp`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `quot_list`
--
ALTER TABLE `quot_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_qid` (`quot_id`);

--
-- Indexes for table `quot_temp`
--
ALTER TABLE `quot_temp`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `qutoservice`
--
ALTER TABLE `qutoservice`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `qutoservicelist`
--
ALTER TABLE `qutoservicelist`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `service_temp`
--
ALTER TABLE `service_temp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `supplier_pay`
--
ALTER TABLE `supplier_pay`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_pidsup` (`purchase_id`);

--
-- Indexes for table `sup_pay_details`
--
ALTER TABLE `sup_pay_details`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cust_pay_details`
--
ALTER TABLE `cust_pay_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `performa_list`
--
ALTER TABLE `performa_list`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `performa_temp`
--
ALTER TABLE `performa_temp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `quotservice_temp`
--
ALTER TABLE `quotservice_temp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `quot_list`
--
ALTER TABLE `quot_list`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `quot_temp`
--
ALTER TABLE `quot_temp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `qutoservice`
--
ALTER TABLE `qutoservice`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `qutoservicelist`
--
ALTER TABLE `qutoservicelist`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `service_temp`
--
ALTER TABLE `service_temp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `supplier_pay`
--
ALTER TABLE `supplier_pay`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sup_pay_details`
--
ALTER TABLE `sup_pay_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `customer_pay`
  ADD CONSTRAINT `FK_custinvid` FOREIGN KEY (`invoice_id`) REFERENCES `invoice` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `performa_list`
--
ALTER TABLE `performa_list`
  ADD CONSTRAINT `FK_pinvid` FOREIGN KEY (`invoice_id`) REFERENCES `performa_invoice` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `purchase_order`
--
ALTER TABLE `purchase_order`
  ADD CONSTRAINT `FK_pid` FOREIGN KEY (`purchase_id`) REFERENCES `purchase` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `quot_list`
--
ALTER TABLE `quot_list`
  ADD CONSTRAINT `FK_qid` FOREIGN KEY (`quot_id`) REFERENCES `quotation` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `sales`
--
ALTER TABLE `sales`
  ADD CONSTRAINT `FK_invid` FOREIGN KEY (`invoice_id`) REFERENCES `invoice` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `supplier_pay`
--
ALTER TABLE `supplier_pay`
  ADD CONSTRAINT `FK_pidsup` FOREIGN KEY (`purchase_id`) REFERENCES `purchase` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
