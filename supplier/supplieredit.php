...
session_start();
  ...
  if(isset($_GET['id'])){
	  $id=$_GET['id'];
	  $array=$obj->get_details("`supplier`","*","`id`='$id' and `shop`='$shop'");
	  //print_r($array);
                ...
                <div class="col-md-12">
                    <div id="formPanel" class="panel panel-primary">
                        <div class="panel-heading">
                            <font size="+2">Update Supplier</font>
                        </div>
                        <div class="panel-body">
                            <form action="../action/update.php" method="post" style="font-size:16px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                    	<select name="state" id="state" class="form-control" required="required">
											...
											?>
                                            <option value="<?php echo $state['id']; ?>" <?php if($state['id']==$array['state']){echo "selected"; } ?>><?php echo $state['state']; ?></option>
                                            <?php
													}	
												}
											?>
                                ...
                                <div class="row">
                                    <center>                                        
                                    	<input type="submit" name="update_supplier" value="Save" class="btn btn-success" />
                                    </center>
                                </div><br />
                            </form>
                        </div>
