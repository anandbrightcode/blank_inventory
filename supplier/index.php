    ...
    <?php include "../header.php";?>
                ...
                <div class="col-md-12">
                    <div id="formPanel" class="panel panel-primary" style="display:none;">
                        <div class="panel-heading">
                            <font size="+2">Add Supplier</font>
                            <button class="btn btn-warning pull-right" onclick="showThis('list');">View Suppliers</button>
                        </div>
                        <div class="panel-body">
                            <form action="../action/insert.php" method="post" style="font-size:16px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea name="address" style="resize:vertical;" class="form-control" required="required"></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                    	<select name="state" id="state" class="form-control" required="required">
                                            ...
                                            <?php
                                            	$states=$obj->get_rows("`state`","`id`,`state`","","`state`");
												if(is_array($states)){
                                ...
                                <div class="row">
                                    <center>                                        
                                    	<input type="submit" name="save_supplier" value="Save" class="btn btn-success" />
                                    </center>
                                </div><br />
                            </form>
                        </div>
                    ...
                    <div class="panel panel-danger" id="listPanel">
                        <div class="panel-heading">
                            <font size="+2">Supplier List</font>
                            <button class="btn btn-info pull-right" onclick="showThis('form');">Add Supplier</button>
                        </div><!-- panel-heading closed-->
                        <div class="panel-body">
                            <input type="text" placeholder="Search Supplier By Name Or Id" class="form-control" onkeyup="getSupplierData(this.value)" id="c_search">
                            <br>
                            <div id="query_result">
        ...
        <script language="javascript">
			...
			function navigate(str1,str2){
				...
				xhttp.open("GET", "supplierlist.php?query="+query+"&shop="+shop+"&page="+page, true);
	 			xhttp.send();	
			}
			function confirmDel(){
