                            ...
                            <div class="col-md-10 table-responsive">
                                <table class="table" align="center" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
										<?php 
											$state=$obj->get_details("`state`","`state`","`id`='$array[state]'");
											echo $state['state']; 
										?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                    	<td colspan="2">
                                        	<a href="supplieredit.php?id=<?php echo $id."&pagename=supplier";?>" class="btn btn-info btn-sm">Edit <i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                </table>
                         	</div>
