...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-10">
         <div class="row">
           <div class="col-md-12">
              <span class="text-center text-danger"><h2><i class="fa fa-file-text-o"></i> Performa Invoice</h2></span>
        ...
        <form action="../action/insert.php" method="post" style="padding-top:5px;" class="row" id="idForm" onsubmit="return validatePrint()">
                	...
                	<table class="table table-condensed" style="margin-bottom:0;">
                    	...
                    	<tr>
                            ...
                            <td>
                            	...
                            	<input type="hidden" name="pbutton" id="pbutton" /><input type="hidden" name="shop" id="shop" value="<?php echo $shop; ?>" />
                            </td>
                       	</tr>
                        <tr>
                            <td>
            ...
            <div class="row">
            	...
            	<div class="col-md-12 table-responsive" id="performa_temp" style="max-height:300px; background-color:#FFFFFF; padding:0;">
                	<?php include('performa_temp.php'); ?>
                </div><!-- end of table div -->
                	...
                	<table class="table table-bordered">
                    	...
                    	<tr>
                            ...
                            <td align="center" style="vertical-align:middle;" colspan="6">
                            	<input type="submit" name="save_performa_invoice" id="savebutton" value="Save &amp; Print" class="btn btn-success btn-sm" />
                            </td>
                        </tr>
                    </table>
                </div>
		...
		if(quantity.value==''){
			...
			$.ajax({
			   ...
			   success: function(data)
			   {
					...
					$.ajax({
						type:"GET",
						url:"performa_temp.php",
						data:{shop:shop},
						success: function(data){
							$('#performa_temp').html(data);
							resetAmount();
						}
					});
			   }
 	...
 	function deleteTemp(str1,str2,str3){
		...
		if(confirm("Are you sure you want to Delete this?")){
			$.ajax({
				...
				data: {
					id:id,shop:shop,quantity:quantity,ready_id:ready_id,delete_ptemp:'delete_ptemp'
				},
