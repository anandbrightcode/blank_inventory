...
session_start();
	...
	$obj=new database();
	$words=new notowords;
	$invoice=$obj->get_details("`service`","*","`id`='$inv_id' and `shop`='$shop'");
    $sales=$obj->get_rows("`servicelist`","*","`service_id`='$inv_id' and `shop`='$shop'");
    //print_r($sales); die;
...
<html xmlns="http://www.w3.org/1999/xhtml" moznomarginboxes mozdisallowselectionprint>
    ...
    <body  onafterprint="setTimeout(myFunction, 1000)">
        ...
        <div class="invoice" style="width:1000px;">
            ...
            <div id="text" style="font-style: italic; float: right; margin-top: -20px; margin-right: 35px;"></div>
            ...
            <table align="center" width="95%" height="600" border="1" cellpadding="0" cellspacing="0" class="invoice-table" >
                ...
                <?php
					if(is_array($sales)){
						$i=0;$squantity=0; $amount=0; $discount=0; $taxable=0;
						$cgst=0; $sgst=0; $igst=0; $charity=$gst_value=0; $gstvalue=0;
						foreach($sales as $product){
				?>
                <tr height="30">
                	<td align="center"><?php echo ++$i; ?></td>
                    <td align="center"><?php echo $product['description']; ?></td>
                	<td align="center"><?php echo $product['shsn']; ?></td>
                	<td align="center"><?php echo $product['squantity']; ?></td>
                	<td align="center"><?php echo toDecimal($product['srate']); ?></td>
                	<td align="center"><?php echo $product['suom']; ?></td>
                   <!-- <td align="center"></td>-->
					...
					?><?php */?>
                	<td align="center"><?php echo toDecimal($product['squantity']*$product['srate']); ?></td>
                </tr>
                <?php		  $gstvalue+=$product['ser_gstvalue'];
                ...
                <tr height="20">
					...
					<?php  if($gst){ echo "<td></td>";}?><?php */?>
                    <td></td><td></td><td></td><td></td>
                    <td align="center"><?php echo twoDigits($invoice['sroundoff']); ?></td>
                </tr>
                <?php } ?>
                ...
                <tr height="20">
                	<th></th>
                    <th align="center">GST -<?php echo $ser_gst; ?>%</th><th></th><th align="center"></th>
                 <th></th><th></th>
                    <th align="center" style="font-size:18px;"><?php echo toDecimal($gstvalue); ?></th>
                    </tr>
                <tr height="20">
                	<th></th>
                    <th align="center">Total</th><th></th><th align="center"><?php echo $squantity; ?></th>
					<?php /*?><?php  if($gst){ echo "<th></th>";}?>
                    <th></th><?php */?><th></th><th></th>
                    <th align="center"><?php echo toDecimal($invoice['stotal_amount']); ?></th>
                </tr>
              
                <tr height="20">
             		<td colspan="8">
                        Amount Chargeable (in words) <div style="float: right">E. & O.E.</div><br />
                		<font size="+1">Indian Rupees. <?php echo $words->to_words($invoice['stotal_amount'])." Only";?></font> 
               		</td>
             	</tr>
            </table>
            ...
            ?>
                ...
                <tr>
                    ...
                    <?php } ?>
                    <th align="right"><?php echo toDecimal($samount); ?></th>
                </tr>
            <?php } ?>
                <tr>
                    <td colspan="7" style="border-bottom: 0; padding:10px;">Tax Amount (in words) : Indian Rupees. <?php echo $words->to_words($samount); ?> Only</td>
                </tr>
                <tr>
