    ...
    <head>
		...
		<script src="../bootstrap/js/jquery.js" type="text/javascript"></script>
		 ...
		 <script>
          ...
          //alert("nameOrId:"+nameOrId+"Type="+type);
          ...
          xhttp.open("GET", "staff_details_ajax.php?nameOrId="+nameOrId+"&type="+type, true);
          xhttp.send();
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-10">
         <div class="row">
           <div class="col-md-12">
              <span class="text-center text-danger"><h2><i class="fa fa-file-text-o"></i> Staff Details</h2></span>
         ...
         <div class="row">
         	...
         	<div class="col-md-3"><b>Select Type:</b></div>
            <div class="col-md-4">
            	<select id="select" name="type" class="form-control" onchange="clearThat();">
                    <option value="0">Select</option>
                    <option value="s_det">Basic Staff Details</option>
                    <option value="sal_det">Basic Salary Details</option>
                </select>
            </div>
         ...
         <div class="row">
         	<div class="col-md-3"></div>
         	<div class="col-md-3"><b>Enter Name Or Id:</b></div>
            <div class="col-md-4"><input type="text" name="nameOrId" id="search_by" onkeyup="getData(this.value);" class="form-control" /></div>
         	<div class="col-md-2"></div>
         </div><!--end of type row-->
         </form>
         <div class="row" id="staff_data" style="margin-left:0">
		 	<?php include "staff_details_ajax.php";?>
         </div><!--end of table-->
